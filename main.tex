...
\begin{document}
	...
	Their are a number of variables that I could use to change difficulty:
	\begin{itemize}
	  \item The walk speed.
	...
	There is little to none story in the game. This was mostly due to my reluctance to my reluctance to include one.
