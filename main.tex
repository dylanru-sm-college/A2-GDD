...
\begin{document}
	...
	\section{General Technical Aspects}
	\subsection{Engine}
	I am using, if it's not clear already, UE5. This is because it is one of the biggest engines and it has some of the best tooling available.
	\subsection{Performance Targets}
	I want the game to run at a reasonable 60FPS on a Nvidia Geforce 1660 since that is a low-middle end GPU I own and therefore can test on.
