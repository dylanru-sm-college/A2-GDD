...
\begin{document}
	...
	I am planning to build my video game for the x64 CPU architecture for Windows and the x64 CPU architecture for Linux. Though Linux can run Windows executables through the \href{https://www.winehq.org}{Wine} translation layer, I'd like to also expermiment with making builds for other operating systems as well.
	...
	\newpage
	\subsection{TODO: Target Audience}
	\subsection{TODO: Unique Selling Points}
